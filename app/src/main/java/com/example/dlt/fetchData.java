...
public class fetchData extends AsyncTask<Void,Void,Void> {
    ...
    public Void doInBackground(Void... voids) {
        try { //   UCRzO050f2DOQ0iZsylVH4dw
            URL url = new URL("https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UChLtXXpo4Ge1ReTEboVvTDg&eventType=live&type=video&key=AIzaSyCoFnySF8hOI0Z1pBqlqG0Lc0Ed-guRU80");
